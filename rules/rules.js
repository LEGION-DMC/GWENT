const rulesData = {
	target: {
		...
		type: 'rule',
		content: `
			<p style="text-align: center;">Гвинт — это дуэль двух армий, где победа зависит от стратегического планирования и умения управлять своими ресурсами.</p>
			
			<div class="bloc-rule">
				<div>
					<h3>Главная цель</h3>
					<p><strong>Выиграть два раунда из трёх.</strong> Матч состоит из трёх раундов. Игрок, который побеждает в двух раундах, объявляется победителем матча.</p>
				</div>
			</div>
			...
			<div class="bloc-rule">
                <div>
                    <h3>Время хода</h3>
                    <ul>
                        <li>На ход каждому даётся по 1 мин.</li>
                        <li>При первом бездействие, следует наказание: вы теряете 1 карту с руки (карта отправляется в Сброс)</li>
                        <li>При последующем бездействии: следует автоматическое поражение в раунде.</li>
                    </ul>
                </div>
            </div>
			...
			<div class="bloc-rule">
                <div>
                    ...
                    <ul>
                        ...
                        <li>После паса игрок больше не может разыгрывать карты в этом раунде и пропускает все свои последующие ходы</li>
			...
			<div class="bloc-rule">
				<div>
					<h3>Определение победителя</h3>
					<ul>
						<li>В конце раунда сравнивается <strong>общая сила</strong> всех карт на поле у каждого игрока.</li>
						<li>Игрок с <strong>большей суммой силы</strong> выигрывает раунд.</li>
						<li>При равной сумме силы раунд считается ничейным. И победа засчитывается обоим игрокам.</li>
						<li>Игра заканчивается, как только один из игроков выигрывает два раунда.</li></br>
						<p style="font-style: italic;"><strong style="color: red;">Важно:</strong> Фракция <strong>Нильфгаард</strong> получает победу в раунде при ничейном счёте.</p>
					</ul>
				</div>
			</div>
		`
    ...
    faction: {
        ...
        content: `
            ...
            <div class="bloc-rule">
                ...
                <div class="faction">
                    <h3>Нильфгаард</h3>
                    <p>Вся Большая земля дрожит от чеканного шага тяжеловооруженных нильфгаардских пехотинцев. За ними следом движутся плюющие огнем боевые машины, златоустые эмиссары, наемные убийцы с окровавленными стилетами, покрытыми ядом. Жители Севера с ужасом наблюдают за этим походом из-за полуприкрытых ставен и шепчут слова молитвы: «Мелитэле, Добрая Мать, сохрани нас от зла, не дай Черным потравить нив наших, не дай им заковать в цепи чад наших...» Но судя по высоким столбам дыма вдоль Понтара и Яруги, богиня глуха к этим мольбам.</p>
                    <p style="color: #796fc0; font-style: italic;"><strong>Способность фракции:</strong> При равном счёте по окончании раунда победа засчитывается игравшему данной фракцией.</p>
                </div>
            </div>
            ...
            <div class="bloc-rule">
                ...
                <div class="faction">
                    ...
                    <p>Ни при одном дворе, ни в одной библиотеке, ни в одной академии нет точной карты Королевств Севера. Ибо стоит картографу провести последнюю черту, как один из многочисленных королей, принцев или маркграфов уже атакует соседа и переносит границу. Без конца кто-то с кем-то воюет: то Аэдирн с Каэдвеном, то Темерия с Лирией... Однако ж эта безумная грызня дает закалку. Жители Севера — искусные воины, стойкие и привыкшие к лишениям. Нелегко разбить их, особенно когда им случается забыть о раздорах и встать плечом к плечу против врага. Однако, как только нордлинги одерживают победу, они снова бросаются друг на друга...</p>
                    <p style="color: #796fc0; font-style: italic;"><strong>Способность фракции:</strong> На этапе Муллигана может заменить до 3 карт (вместо стандартных 2).</p>
                </div>
            </div>
            ...
            <div class="bloc-rule">
                ...
                <div class="faction">
                    <h3>Скоя'таэли</h3>
                    <p>Когда-то Большой землей владели Старшие расы: эльфы, краснолюды, гномы. Люди оттеснили их в захолустье, в горы, в густые леса — и ждут, пока те вымрут от голода и болезней, чтобы вырвать у них из рук эти последние, бесплодные клочки земли. Но некоторые эльфы и краснолюды ищут иной смерти: с песней на устах, с людской кровью на руках. На пояса и шапки они вешают беличьи хвосты и таятся вдоль большаков, готовые убить всех dh'oine на своем пути. Они знают, что никогда не победят, не возьмут верх над своими угнетателями. Но это вовсе не ослабляет их желания бунтовать, а лишь усиливает его. В конце концов, скоя'таэлям нечего терять.</p>
                    <p style="color: #796fc0; font-style: italic;"><strong>Способность фракции:</strong> За фракцией закреплено право выбора первого хода в каждом раунде.</p>
                </div>
            </div>
            ...
            <div class="bloc-rule">	
                ...
                <div class="faction">
                    ...
                    <p style="font-style: italic; color: red;"> Данные карты, не принадлежащие ни одной из фракций и доступны всем</p>
                </div>
            </div>
        `
    },
        ...
        content: `
            ...
            <div class="bloc-rule">
                <div>
                    ...
                    <ul>
                        <li><strong>Количество всех карт в колоде:</strong> 15-25 карт</li>
                        <li><strong>Минимальное количество карт отрядов:</strong> 10 карт</li>
                        <li><strong>Количество специальных карт:</strong> 3-5 карт</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="bloc-rule">
                ...
                <div class="cards">
                    <h3>Отряды</h3>
                    <p>Основные боевые единицы, которые размещаются на поле боя и имеют очки Силы.</p>
                    <p><strong>Особенности:</strong></p>
                    <ul>
                        <li>Имеют числовое значение силы (от 1 до 15)</li>
                        <li>Размещаются на поле в одном из трёх боевых рядов</li>
                        <li>Остаются на поле до конца раунда</li>
                        <li>Среди карт Отрядов, есть карты <strong>Героев</strong> - данные карты не подвержены ослаблению, усилению и уничтожению. </br> На них не действуют способности карт: Погоды, Казнь, Чучело и другие эффекты, которые могут изменить их силу или удалить с поля.</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="bloc-rule">
                ...
                <div class="cards">
                    <h3>Специальные</h3>
                    <p>Специальные карты, которые оказывают немедленный эффект.</p>
                    <p><strong>Особенности:</strong></p>
                    <ul>
                        <li>Не имеют силы и не размещаются на поле (за исключением погодных карт и Чучела)</li>
                        <li>Эффект применяется мгновенно при розыгрыше</li>
                        <li>После применения - отправляются в Сброс</li>
                        <li>Могут наносить урон и усиливать карты Отрядов</li>
                    </ul>
					<p><strong>Карты Погоды: Особый класс Специальных карт</strong></p>
                    <ul>
                        <li>Размещаются на поле, в особом слоте</li>
                        <li>Эффект применяется мгновенно при розыгрыше</li>
						<li>Карта после применения остаётся на поле до конца раунда, или пока карта не будет заменена или отменена другой</li>
                        <li>Несут негативный эффект для карт Отрядов</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="bloc-rule">
                ...
                <div class="cards">
                    ...
                    <p><strong>Особенности:</strong></p>
                    <ul>
                        <li>Размещаются на поле, занимая место в боевых рядах</li>
                        <li>Эффект применяется мгновенно при розыгрыше</li>
						<li>Карта после применения остаётся на поле до конца раунда, или пока карта не будет уничтожена</li>
            ...
            <div class="bloc-rule">
                ...
                <div class="cards">
                    <h3>Тактики</h3>
                    <p>Стратегические карты, применяют групповые или маштабные эффекты</p>
                    <p><strong>Особенности:</strong></p>
                    <ul>
                        <li>Размещаются на поле, в особом слоте</li>
                        <li>Эффект действует разово, и карта при этом остаётся на поле до конца раунда</li>
                        <li>Могут усиливать отряды, давать пассивные бонусы или особые способности</li>
                        <li>Применяются на целые ряды для группы карт или карт с определённым тегом</li>
                    </ul>
                </div>
            </div>
            </div>
		...
		content: `
			...
			<div class="bloc-rule">
				<div>
					...
					<p>Случайное определение очерёдности хода путём подбрасывания монеты.</p>
					<p><strong>Результат:</strong></p>
					<ul>
						<li>Крепость: Игрок ходит первым в первом раунде</li>
						<li>Факел: Противник ходит первым в первом раунде</li>
					</ul>
					<p style="font-style: italic;"><strong style="color: red;">Важно:</strong> В следующих раундах первым ходит победивший в предыдущем раунде.</p>
				</div>
			</div>
			...
			<div class="bloc-rule">
				<div>
					...
					<h4>Особенности раздачи в разных режимах игры:</h4>
					<div class="bloc-rule">
						<div>
							...
							<ul>
								...
								<li>Стратегия требует тщательного планирования</li>
							</ul>
						</div>
					</div>
			...
			<div class="bloc-rule">
				<div>
					...
					<p style="font-style: italic;"><strong style="color: red;">Важно:</strong> Королевства Севера: Могут заменить до 3 карт</p>
					<p style="font-style: italic;"><strong style="color: red;">Важно:</strong> Синдикат: Может отменить Муллиган противника</p>
				</div>
			</div>
		`
	},
        ...
        content: `
			...
			<div class="bloc-rule">
                <div>
                    ...
                    <ul>
                        <li>Каждый ряд вмещает до 9 карт</li>
                        <li>В свой ход, можно разместить только одну карту</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="bloc-rule">
                ...
                <div>
                    ...
                    <p>Третий ряд для осадных орудий и поддержки.</p>
                    <p><strong>Типичные отряды:</strong></p>
                    <ul>
                        <li>Орудия</li>
                        <li>Гиганты</li>
        ...
        content: `
            ...
            <div class="bloc-rule">
                <div>
                    <h3>Сбор колоды</h3>
                    <ul>
                        <li><strong>ЛКМ (Левая кнопка мыши) по карте:</strong> Добавление/Удаление карты из колоды.</li>
                        <li><strong>ПКМ (Правая кнопка мыши) по карте:</strong> Просмотр подробной информации о карте.</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="bloc-rule">
                <div>
                    ...
                    <ul>
                        ...
                        <li><strong>Важно:</strong> Каждая фракция имеет отдельные файлы сохранения. Нельзя загрузить колоду другой фракции.</li>
            ...
            <div class="bloc-rule">
                <div>
                    ...
                    <ul>
                        <li><strong>ЛКМ (Левая кнопка мыши) по карте в руке:</strong> Выбор карты для размещения на поле боя.</li>
                        <li><strong>ПКМ (Правая кнопка мыши) по карте:</strong> Просмотр подробной информации о карте.</li>
                        <li><strong>Нажатие на стопку карт:</strong> Просмотр карт в Колоде/Сбросе (так же доступен Сброс противника).</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="bloc-rule">
                <div>
                    ...
                    <ul>
                        <li>После выбора карты из руки, доступные ряды будут подсвечены.</li>
        ...
        content: `
            ...
            <div class="bloc-rule">
                <div>
                    ...
                    <ul>
                        ...
                        <li><strong>Рука:</strong> Карты, которые игрок может разыграть в текущем раунде.</li>
                        <li><strong>Поле:</strong> Область, где размещаются карты.</li>
                        <li><strong>Сброс:</strong> Карты, которые были разыграны в предыдущем раунде, уничтожены или сброшены.</li>
                        <li><strong>Удаление:</strong> Карты, удалённые из сражения полностью, минуя Сброс. Вернуть их в игру, как правило, невозможно.</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="bloc-rule">
                <div>
                    ...
                    <ul>
                        <li><strong>Пас:</strong> Пропуск хода, после которого игрок не может играть карты в этом раунде.</li>
            ...
            <div class="bloc-rule">
                <div>
                    ...
                    <ul>
                        <li><strong>Адвантаж (преимущество):</strong> Ситуация, когда у игрока больше карт в руке, чем у противника.</li>
                        <li><strong>Драй-Пас:</strong> Пас на пустой стол, с целью вынудить противника сбросить карту в текущем раунде, чтобы получить преимущество в следующем.</li>
            ...
            <div class="bloc-rule">
                <div>
                    <h3>Визуальные обозначения</h3>
                    <p><strong>Сила отрядов:</strong> Цвет числового значения силы карты отряда указывает на её текущее состояние относительно изначальной силы:</p>
                    <ul style="list-style: none;">
                        <li>
                            <strong style="color: #ff4444; font-size: 18px;">●</strong> 
                            <strong style="color: #ff4444;">Красный</strong> — 
                            <span style="color: #ff4444;">повреждённый отряд</span> (текущая сила меньше изначальной).
                        </li>
                        <li>
                            <strong style="color: #ffffff; font-size: 18px;">●</strong> 
                            <strong style="color: #ffffff;">Белый</strong> — 
                            <span style="color: #ffffff;">отряд с изначальной силой.</span>
                        </li>
                        <li>
                            <strong style="color: #0ba00b; font-size: 18px;">●</strong> 
                            <strong style="color: #0ba00b;">Зелёный</strong> — 
                            <span style="color: #0ba00b;">усиленный отряд</span> (текущая сила больше изначальной).
                        </li>
                    </ul>
                    </div>
                </div>
	...
	glossary: {
        title: 'Глоссарий',
        description: 'Персонажи, Расы и организации',
        type: 'glossary',
        content: `
            <div class="bloc-rule">
                <div>
                    <h3>Персонажи</h3>
                    <ul>
                        <li><strong>Ведьмаки</strong> — это мутанты, тренированные с детства во имя единственной цели: защищать всё человечество от бесчисленных грязных тварей, населяющих эти земли. Существует несколько ведьмачьих школ, представителей которых можно узнать по разным медальонам на шее. Медальон предупреждает лёгкой вибрацией о приближающейся опасности или магических колебаниях неподалёку. За последние годы каста ведьмаков сократилась до горстки действующих охотников. Столь мало их осталось, что мир начинает напоминать времена, когда их и вовсе не было.</li>
                    </ul>
                </div>
            </div>
        `
