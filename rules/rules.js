const rulesData = {
    ...
    deckBuilding: {
        ...
        content: `
            ...
            <div class="bloc-rule"><img src="deck/unit.png" alt="Отряды" class="rule-modal__image"><div class="cards"><h3>Отряды</h3><p>Основные боевые единицы, которые размещаются на поле боя и имеют очки Силы.</p><p><strong>Особенности:</strong></p><ul><li>Имеют числовое значение силы (от 1 до 10)</li><li>Размещаются на поле в одном из трёх боевых рядов</li><li>Остаются на поле до конца раунда</li><li>Среди карт Отрядов, есть карты <strong>Героев</strong> - данные карты не подвержены ослаблению, усилению и уничтожению. На них не действуют способности карт: Погоды, Казнь, Чучело и другие эффекты, которые могут изменить их силу или удалить с поля.</li></ul></div></div>
