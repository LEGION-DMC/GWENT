const factionsData = {
	...
	syndicate: {
        ...
        name: 'Синдикат',
        leaderName: 'Тесак',
        description: 'Одни сражаются за честь, а другие — за империю. Одни сражаются за короля, а другие — за свободу. Те, кто состоит в Синдикате «Большой четврки», не станут сражаться ни за что, кроме богатства. И если щедро им заплатить, они будут готовы для вас на любые деяния… Даже самые чудовищные.',
