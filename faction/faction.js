const factionsData = {  
    ...
    nilfgaard: {
        ...
        descriptionfull: 'Вtcm Континент дрожит от чеканного шага нильфгаардских пехотинцев. За ними следом движутся плюющие огнем боевые машины, наемные убийцы с окровавленными стилетами. Жители Севера с ужасом наблюдают за этим походом и шепчут слова молитвы',
